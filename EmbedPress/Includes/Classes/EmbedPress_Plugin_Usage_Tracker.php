	...
	class EmbedPress_Plugin_Usage_Tracker
	{
		...
		public function deactivation_reasons()
		{
			...
			$form['options'] = array(
				...
				[
					'label' => esc_html__('I found a better plugin', 'embedpress'),
					'extra_field' => esc_html__('Please share which plugin', 'embedpress')
				],
				__("I couldn't get the plugin to work", 'embedpress'),
				__('It\'s a temporary deactivation', 'embedpress'),
				[
					'label' => esc_html__('Other', 'embedpress'),
					'extra_field' => esc_html__('Please share the reason', 'embedpress'),
					'type' => 'textarea'
				]
			);
