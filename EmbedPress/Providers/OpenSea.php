                        ...
                        <?php if(!empty($loadmore)):  ?>
                            <?php if((isset($params['limit']) && isset($params['itemperpage'])) && $params['limit'] > $params['itemperpage']) : ?>
                                <div class="ep-loadmore-wrapper">
                                    <button class="btn btn-primary nft-loadmore" data-iconcolor="<?php echo esc_attr($this->getColor('loadmoreTextColor') ); ?>" <?php echo $this->createStye('loadmoreTextColor', 'loadmoreTextFontsize', 'loadmoreBackgroundColor'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>> <?php echo esc_html($loadmorelabel); ?></button>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
