...
$sources = [
    ...
    ["name" => "Spotify", "icon" => $icon_src . "/spotify.png", "type" => "audio", "settings" => true, "settings_url" => "/wp-admin/admin.php?page=embedpress&page_type=soundcloud", "doc_url" => "https://embedpress.com/docs/embed-spotify-audios-wordpress/"],
