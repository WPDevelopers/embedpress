...
$sources = [
    ["name" => "YouTube", "icon" => $icon_src . "/youtube.png", "type" => "video",  "doc_url" => ""],
    ["name" => "Youtube Live", "icon" => $icon_src . "/youtubelive.png", "type" => "stream",  "doc_url" => ""],
    ["name" => "Vimeo", "icon" => $icon_src . "/vimeo.png", "type" => "video",  "doc_url" => ""],
    ["name" => "Wistia", "icon" => $icon_src . "/wistia.png", "type" => "video",  "doc_url" => ""],
    ["name" => "Twitch", "icon" => $icon_src . "/twitch.png", "type" => "video",  "doc_url" => ""],
    ["name" => "Dailymotion", "icon" => $icon_src . "/dailymotion.png", "type" => "video",  "doc_url" => ""],
    ["name" => "SoundCloud", "icon" => $icon_src . "/soundcloud.png", "type" => "audio",  "doc_url" => ""],
    ["name" => "Spotify", "icon" => $icon_src . "/spotify.png", "type" => "audio",  "doc_url" => ""],
    ["name" => "Google Calendar", "icon" => $icon_src . "/google-calendar.png", "type" => "google",  "doc_url" => ""],
    ["name" => "OpenSea", "icon" => $icon_src . "/opensea.png", "type" => "google",  "doc_url" => ""],
    ["name" => "Calendly", "icon" => $icon_src . "/calendly.png", "type" => "calendar",  "doc_url" => ""],
    ["name" => "Google Drawings", "icon" => $icon_src . "/google-drawings.png", "type" => "google", "doc_url" => ""],
    ["name" => "Google Docs", "icon" => $icon_src . "/google-docs.png", "type" => "google", "doc_url" => ""],
    ["name" => "Google Slides", "icon" => $icon_src . "/google-slides.png", "type" => "google", "doc_url" => ""],
    ["name" => "Google Forms", "icon" => $icon_src . "/google-forms.png", "type" => "google", "doc_url" => ""],
    ["name" => "Google Maps", "icon" => $icon_src . "/google-maps.png", "type" => "google", "doc_url" => ""],
    ["name" => "Google Sheets", "icon" => $icon_src . "/google-sheets.png", "type" => "google", "doc_url" => ""],
    ["name" => "Twitter", "icon" => $icon_src . "/twitter.png", "type" => "social", "doc_url" => ""],
    ["name" => "Facebook", "icon" => $icon_src . "/facebook.png", "type" => "social", "doc_url" => ""],
    ["name" => "Instagram", "icon" => $icon_src . "/instagram.png", "type" => "social", "doc_url" => ""],
    ["name" => "Github", "icon" => $icon_src . "/github.png", "type" => "social", "doc_url" => ""],
    ["name" => "TikTok", "icon" => $icon_src . "/tiktok.png", "type" => "social", "doc_url" => ""],
    ["name" => "Reddit", "icon" => $icon_src . "/reddit.png", "type" => "social", "doc_url" => ""],
    ["name" => "WordPress.Tv", "icon" => $icon_src . "/wordpress-tv.png", "type" => "video", "doc_url" => ""],
    ["name" => "Apple Podcast", "icon" => $icon_src . "/apple-podcast.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Tumblr", "icon" => $icon_src . "/tumblr.png", "type" => "social", "doc_url" => ""],
    ["name" => "DeviantArt", "icon" => $icon_src . "/deviantart.png", "type" => "social", "doc_url" => ""],
    ["name" => "UPS", "icon" => $icon_src . "/ups.png", "type" => "stream", "doc_url" => ""],
    ["name" => "Rumble", "icon" => $icon_src . "/rumble.png", "type" => "video", "doc_url" => ""],
    ["name" => "Gumroad", "icon" => $icon_src . "/gumroad.png", "type" => "stream", "doc_url" => ""],
    ["name" => "Imgur Images", "icon" => $icon_src . "/imgur-images.png", "type" => "image", "doc_url" => ""],
    ["name" => "Streamable", "icon" => $icon_src . "/streamable.png", "type" => "video", "doc_url" => ""],
    ["name" => "Smugmug", "icon" => $icon_src . "/smugmug.png", "type" => "image", "doc_url" => ""],
    ["name" => "Scribd", "icon" => $icon_src . "/scribd.png", "type" => "pdf", "doc_url" => ""],
    ["name" => "Flickr Images", "icon" => $icon_src . "/flickr-images.png", "type" => "image", "doc_url" => ""],
    ["name" => "Ifixit", "icon" => $icon_src . "/ifixit.png", "type" => "image", "doc_url" => ""],
    ["name" => "SlideShare", "icon" => $icon_src . "/slideshare.png", "type" => "pdf", "doc_url" => ""],
    ["name" => "Giphy Gifs", "icon" => $icon_src . "/giphy-gifs.png", "type" => "image", "doc_url" => ""],
    ["name" => "TED Videos", "icon" => $icon_src . "/ted-videos.png", "type" => "video", "doc_url" => ""],
    ["name" => "Meetup", "icon" => $icon_src . "/meetup.png", "type" => "social", "doc_url" => ""],
    ["name" => "Wordwall", "icon" => $icon_src . "/wordwall.png", "type" => "social", "doc_url" => ""],
    ["name" => "DocDroid", "icon" => $icon_src . "/docdroid.png", "type" => "pdf", "doc_url" => ""],
    ["name" => "Kickstarter", "icon" => $icon_src . "/kickstarter.png", "type" => "social", "doc_url" => ""],
    ["name" => "Getty Images", "icon" => $icon_src . "/getty-images.png", "type" => "image", "doc_url" => ""],
    ["name" => "Vidyard", "icon" => $icon_src . "/vidyard.png", "type" => "video", "doc_url" => ""],
    ["name" => "CodePen", "icon" => $icon_src . "/codepen.png", "type" => "social", "doc_url" => ""],
    ["name" => "Padlet", "icon" => $icon_src . "/padlet.png", "type" => "social", "doc_url" => ""],
    ["name" => "Hearthis", "icon" => $icon_src . "/hearthis.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Codesandbox", "icon" => $icon_src . "/codesandbox.png", "type" => "social", "doc_url" => ""],
    ["name" => "Gyazo", "icon" => $icon_src . "/gyazo.png", "type" => "image", "doc_url" => ""],
    ["name" => "Archivos", "icon" => $icon_src . "/archivos.png", "type" => "stream", "doc_url" => ""],
    ["name" => "Gloria TV", "icon" => $icon_src . "/gloria-tv.png", "type" => "video", "doc_url" => ""],
    ["name" => "BoomPlay", "icon" => $icon_src . "/boomplay.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Animoto", "icon" => $icon_src . "/animoto.png", "type" => "video", "doc_url" => ""],
    ["name" => "Gfycat", "icon" => $icon_src . "/gfycat.png", "type" => "video", "doc_url" => ""],
    ["name" => "MixCloud Audio", "icon" => $icon_src . "/mixcloud-audio.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Fader", "icon" => $icon_src . "/fader.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Coub Videos", "icon" => $icon_src . "/coub-videos.png", "type" => "video", "doc_url" => ""],
    ["name" => "SpeakerDeck", "icon" => $icon_src . "/speakerdeck.png", "type" => "presentation", "doc_url" => ""],
    ["name" => "Wizer", "icon" => $icon_src . "/wizer.png", "type" => "educational", "doc_url" => ""],
    ["name" => "ReverbNation", "icon" => $icon_src . "/reverbnation.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Spreaker", "icon" => $icon_src . "/spreaker.png", "type" => "audio", "doc_url" => ""],
    ["name" => "CircuitLab", "icon" => $icon_src . "/circuitlab.png", "type" => "educational", "doc_url" => ""],
    ["name" => "LearningApps", "icon" => $icon_src . "/learningapps.png", "type" => "educational", "doc_url" => ""],
    ["name" => "iHeartRadio", "icon" => $icon_src . "/iheartradio.png", "type" => "audio", "doc_url" => ""],
    ["name" => "RunKit", "icon" => $icon_src . "/runkit.png", "type" => "development", "doc_url" => ""],
    ["name" => "Flourish", "icon" => $icon_src . "/flourish.png", "type" => "data", "doc_url" => ""],
    ["name" => "NRK Radio", "icon" => $icon_src . "/nrk-radio.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Roomshare", "icon" => $icon_src . "/roomshare.png", "type" => "social", "doc_url" => ""],
    ["name" => "Infogram", "icon" => $icon_src . "/infogram.png", "type" => "data", "doc_url" => ""],
    ["name" => "FITE", "icon" => $icon_src . "/fite.png", "type" => "sports", "doc_url" => ""],
    ["name" => "Digiteka", "icon" => $icon_src . "/digiteka.png", "type" => "video", "doc_url" => ""],
    ["name" => "Toornament", "icon" => $icon_src . "/toornament.png", "type" => "sports", "doc_url" => ""],
    ["name" => "Sapa", "icon" => $icon_src . "/sapa.png", "type" => "social", "doc_url" => ""],
    ["name" => "Huffduffer", "icon" => $icon_src . "/huffduffer.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Geograph UK", "icon" => $icon_src . "/geograph-uk.png", "type" => "map", "doc_url" => ""],
    ["name" => "Tvcf", "icon" => $icon_src . "/tvcf.png", "type" => "video", "doc_url" => ""],
    ["name" => "Cloudup", "icon" => $icon_src . "/cloudup.png", "type" => "file", "doc_url" => ""],
    ["name" => "Sudomemo", "icon" => $icon_src . "/sudomemo.png", "type" => "social", "doc_url" => ""],
    ["name" => "Fitapp", "icon" => $icon_src . "/fitapp.png", "type" => "health", "doc_url" => ""],
    ["name" => "Edumedia", "icon" => $icon_src . "/edumedia.png", "type" => "educational", "doc_url" => ""],
    ["name" => "Ludus", "icon" => $icon_src . "/ludus.png", "type" => "presentation", "doc_url" => ""],
    ["name" => "Chirbit Audio", "icon" => $icon_src . "/chirbit-audio.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Clyp Audio", "icon" => $icon_src . "/clyp-audio.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Hippo Videos", "icon" => $icon_src . "/hippo-videos.png", "type" => "video", "doc_url" => ""],
    ["name" => "Zingsoft", "icon" => $icon_src . "/zingsoft.png", "type" => "development", "doc_url" => ""],
    ["name" => "Didacte", "icon" => $icon_src . "/didacte.png", "type" => "educational", "doc_url" => ""],
    ["name" => "Lumiere", "icon" => $icon_src . "/lumiere.png", "type" => "photo", "doc_url" => ""],

    ["name" => "Subscribi", "icon" => $icon_src . "/subscribi.png", "type" => "subscription", "doc_url" => ""],
    ["name" => "Tuxx", "icon" => $icon_src . "/tuxx.png", "type" => "social", "doc_url" => ""],
    ["name" => "Rcvis", "icon" => $icon_src . "/rcvis.png", "type" => "social", "doc_url" => ""],
    ["name" => "LillePod", "icon" => $icon_src . "/lillepod.png", "type" => "podcast", "doc_url" => ""],

    ["name" => "Onsizzle", "icon" => $icon_src . "/onsizzle.png", "type" => "social", "doc_url" => ""],
    ["name" => "SocialExplorer", "icon" => $icon_src . "/socialexplorer.png", "type" => "social", "doc_url" => ""],
    ["name" => "Namchey", "icon" => $icon_src . "/namchey.png", "type" => "social", "doc_url" => ""],
    ["name" => "GetShow", "icon" => $icon_src . "/getshow.png", "type" => "social", "doc_url" => ""],
    ["name" => "Orbitvu", "icon" => $icon_src . "/orbitvu.png", "type" => "photo", "doc_url" => ""],
    ["name" => "Wave", "icon" => $icon_src . "/wave.png", "type" => "audio", "doc_url" => ""],
    ["name" => "ShortNote", "icon" => $icon_src . "/shortnote.png", "type" => "note", "doc_url" => ""],
    ["name" => "Dotsub", "icon" => $icon_src . "/dotsub.png", "type" => "video", "doc_url" => ""],
    ["name" => "Zoomable", "icon" => $icon_src . "/zoomable.png", "type" => "photo", "doc_url" => ""],
    ["name" => "The New York Times", "icon" => $icon_src . "/nytimes.png", "type" => "news", "doc_url" => ""],
    ["name" => "SmashNotes", "icon" => $icon_src . "/smashnotes.png", "type" => "podcast", "doc_url" => ""],

    ["name" => "Commaful", "icon" => $icon_src . "/commaful.png", "type" => "writing", "doc_url" => ""],
    ["name" => "ShowTheWay", "icon" => $icon_src . "/showtheway.png", "type" => "map", "doc_url" => ""],
    ["name" => "Blogcast", "icon" => $icon_src . "/blogcast.png", "type" => "podcast", "doc_url" => ""],
    ["name" => "VideoPress", "icon" => $icon_src . "/videopress.png", "type" => "video", "doc_url" => ""],
    ["name" => "Ethfiddle", "icon" => $icon_src . "/ethfiddle.png", "type" => "development", "doc_url" => ""],
    ["name" => "KaKao TV", "icon" => $icon_src . "/kakaotv.png", "type" => "video", "doc_url" => ""],
    ["name" => "Crowdsignal", "icon" => $icon_src . "/crowdsignal.png", "type" => "survey", "doc_url" => ""],
    ["name" => "Medienarchiv", "icon" => $icon_src . "/medienarchiv.png", "type" => "media", "doc_url" => ""],

    ["name" => "MermaidInk", "icon" => $icon_src . "/mermaidink.png", "type" => "graphics", "doc_url" => ""],
    ["name" => "AudioClip", "icon" => $icon_src . "/audioclip.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Polldaddy Polls", "icon" => $icon_src . "/polldaddy.png", "type" => "survey", "doc_url" => ""],
    ["name" => "Sway", "icon" => $icon_src . "/sway.png", "type" => "presentation", "doc_url" => ""],
    ["name" => "Geograph", "icon" => $icon_src . "/geograph.png", "type" => "map", "doc_url" => ""],
    ["name" => "VoxSnap", "icon" => $icon_src . "/voxsnap.png", "type" => "audio", "doc_url" => ""],

    ["name" => "Overflow", "icon" => $icon_src . "/overflow.png", "type" => "web", "doc_url" => ""],
    ["name" => "The NY Times IN", "icon" => $icon_src . "/nytimesin.png", "type" => "news", "doc_url" => ""],
    ["name" => "SproutVideo", "icon" => $icon_src . "/sproutvideo.png", "type" => "video", "doc_url" => ""],
    ["name" => "SongLink", "icon" => $icon_src . "/songlink.png", "type" => "audio", "doc_url" => ""],
    ["name" => "23hq Photos", "icon" => $icon_src . "/23hq.png", "type" => "photo", "doc_url" => ""],
    ["name" => "Geograph UK", "icon" => $icon_src . "/geograph-uk.png", "type" => "map", "doc_url" => ""],
    ["name" => "ISSUU", "icon" => $icon_src . "/issuu.png", "type" => "document", "doc_url" => ""],
    ["name" => "Roosterteeth", "icon" => $icon_src . "/roosterteeth.png", "type" => "video", "doc_url" => ""],
    ["name" => "Daily Mile", "icon" => $icon_src . "/dailymile.png", "type" => "health", "doc_url" => ""],
    ["name" => "Sketchfab", "icon" => $icon_src . "/sketchfab.png", "type" => "3D", "doc_url" => ""],
    ["name" => "Matterport", "icon" => $icon_src . "/matterport.png", "type" => "3D", "doc_url" => ""],
    ["name" => "Code point", "icon" => $icon_src . "/codepoint.png", "type" => "data", "doc_url" => ""],
    ["name" => "MBM", "icon" => $icon_src . "/mbm.png", "type" => "audio", "doc_url" => ""],
    ["name" => "Datawrapper", "icon" => $icon_src . "/datawrapper.png", "type" => "data", "doc_url" => ""],
    ["name" => "Eyrie", "icon" => $icon_src . "/eyrie.png", "type" => "photo", "doc_url" => ""],
    ["name" => "Cambridge Map", "icon" => $icon_src . "/cambridge-map.png", "type" => "map", "doc_url" => ""],
    ["name" => "Geograph G", "icon" => $icon_src . "/geograph-g.png", "type" => "map", "doc_url" => ""],
    ["name" => "Mermaid", "icon" => $icon_src . "/mermaid.png", "type" => "graphics", "doc_url" => ""],
    ["name" => "Facebook Live", "icon" => $icon_src . "/facebooklive.png", "type" => "stream", "doc_url" => ""],
    ["name" => "Polarishare", "icon" => $icon_src . "/polarishare.png", "type" => "stream", "doc_url" => ""],
...
$sources = [
    ...
    ["name" => "Calendly", "icon" => $icon_src . "/calendly.png", "type" => "calendar", "settings" => true, "settings_url" => "/wp-admin/admin.php?page=embedpress&page_type=twitch", "doc_url" => "https://embedpress.com/docs/how-to-embed-calendly-in-wordpress/"],
    ...
    ["name" => "Google Forms", "icon" => $icon_src . "/google-forms.png", "type" => "google", "doc_url" => "https://embedpress.com/docs/how-to-embed-google-forms-in-wordpress/"],
    ...
    ["name" => "Twitter", "icon" => $icon_src . "/twitter.png", "type" => "social",  "doc_url" => "https://embedpress.com/docs/embed-twitter-tweets-wordpress/"],
    ...
    ["name" => "Coub", "icon" => $icon_src . "/coub.png", "type" => "video", "doc_url" => "https://embedpress.com/docs/embed-coub-videos-iwordpress/"],
