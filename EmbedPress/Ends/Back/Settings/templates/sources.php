...
$sources = [
    ...
    ["name" => "Twitch", "icon" => $icon_src . "/twitch.png", "type" => "video", "settings" => true, "settings_url" => "/wp-admin/admin.php?page=embedpress&page_type=twitch", "doc_url" => "https://embedpress.com/docs/embed-twitch-streams-chat/"],
    ...
    ["name" => "Spotify", "icon" => $icon_src . "/spotify.png", "type" => "audio", "settings" => true, "settings_url" => "/wp-admin/admin.php?page=embedpress&page_type=spotify", "doc_url" => "https://embedpress.com/docs/embed-spotify-audios-wordpress/"],
    ...
    ["name" => "OpenSea NFT", "icon" => $icon_src . "/opensea.png", "type" => "image", "settings" => true, "settings_url" => "/wp-admin/admin.php?page=embedpress&page_type=opensea", "doc_url" => "https://embedpress.com/docs/embed-opensea-nft-collections-wordpress/"],
