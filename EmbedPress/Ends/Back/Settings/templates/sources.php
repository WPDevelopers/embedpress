...
$sources = [
    ...
    ["name" => "Calendly", "icon" => $icon_src . "/calendly.png", "type" => "calendar", "settings" => true, "settings_url" => "/wp-admin/admin.php?page=embedpress&page_type=calendly", "doc_url" => "https://embedpress.com/docs/how-to-embed-calendly-in-wordpress/"],
    ...
    ["name" => "Wave", "icon" => $icon_src . "/wave.png", "type" => "audio", "doc_url" => "https://embedpress.com/docs/how-to-embed-wave-audio-in-wordpress/"],
    ...
    ["name" => "Commaful", "icon" => $icon_src . "/commaful.png", "type" => "writing", "doc_url" => "https://embedpress.com/docs/how-to-embed-commaful-stories-in-wordpress/"],
    ...
    ["name" => "Geograph UK", "icon" => $icon_src . "/geograph-uk.png", "type" => "map", "doc_url" => "https://embedpress.com/docs/how-to-embed-geograph-uk/"],
    ...
    ["name" => "Daily Mile", "icon" => $icon_src . "/dailymile.png", "type" => "health", "doc_url" => "https://embedpress.com/docs/how-to-embed-dailymile-activity-wordpress/"],
    ["name" => "Sketchfab", "icon" => $icon_src . "/sketchfab.png", "type" => "3D", "doc_url" => "https://embedpress.com/docs/how-to-embed-sketchfab-3d-models-in-wordpress/"],
    ["name" => "Matterport", "icon" => $icon_src . "/matterport.png", "type" => "3D", "doc_url" => "https://embedpress.com/docs/how-to-embed-matterport-3d-scans/"],
    ["name" => "Code point", "icon" => $icon_src . "/codepoint.png", "type" => "data", "doc_url" => "https://embedpress.com/docs/how-to-embed-codepoint-in-wordpress/"],
    ["name" => "MBM", "icon" => $icon_src . "/mbm.png", "type" => "audio", "doc_url" => "https://embedpress.com/docs/how-to-embed-mbm-audio-in-wordpress/"],
    ["name" => "Datawrapper", "icon" => $icon_src . "/datawrapper.png", "type" => "data", "doc_url" => "https://embedpress.com/docs/how-to-embed-datawrapper-charts-in-wordpress/"],
    ...
    ["name" => "Cambridge Map", "icon" => $icon_src . "/cambridge-map.png", "type" => "map", "doc_url" => "https://embedpress.com/docs/how-to-embed-cambridge-map-in-wordpress/"],
