                            ...
                            <form class="instagram_account__form form__inline modal-content" action="" method="POST" id="instagram-form">
                                ...
                                <div class="form-group">
                                    <select name="account-option" id="account-option" class="form__control">
                                        <option value="default" selected><?php echo esc_html__('Standard (Recommended)', 'embedpress'); ?></option>
                                        <option value="personal"><?php echo esc_html__('Personal (Legacy)', 'embedpress'); ?></option>
                                        <option value="business"><?php echo esc_html__('Business (Legacy)', 'embedpress'); ?></option>
                                    </select>
                                </div>
