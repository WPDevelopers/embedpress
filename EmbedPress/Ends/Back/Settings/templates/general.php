...
$turn_on_rating_help = isset($g_settings['turn_on_rating_help']) ? intval($g_settings['turn_on_rating_help']) : 1;
			...
			<div class="embedpress__settings__form">
				...
				?>
					<div class="mb-20">
						...
						<div class="form__group turn_on_rating_help">
							<p class="form__label"><?php echo esc_html__('Turn On Rating & Help', 'embedpress'); ?></p>
							<div class="form__control__wrap">
								<label class="input__switch switch__text">
									<input type="checkbox" name="turn_on_rating_help"
										data-default="<?php echo esc_attr($turn_on_rating_help); ?>"
										data-value="<?php echo esc_attr($turn_on_rating_help); ?>" value="1"
										<?php checked('1', $turn_on_rating_help) ?>>
									<span></span>
