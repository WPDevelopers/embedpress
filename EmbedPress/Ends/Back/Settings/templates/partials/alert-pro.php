	...
	<div class="pro__alert__card">
		...
		<p><?php
			echo sprintf(
					...
					__( 'You need to upgrade to the <a href="%s" target="_blank">Premium</a> Version to use this feature', "embedpress" ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
