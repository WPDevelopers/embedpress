...
", "embedpress" ); ?></p>
            <a href="https://embedpress.com/documentation/" class="button radius-10"><?php esc_html_e( "Documentation", "embedpress" ); ?></a>
        </div>
        <div class="embedpress-card">
            <div class="icon">
        ...
        <div class="embedpress-card">
            ...
            <a href="https://wordpress.org/support/plugin/embedpress/reviews/#new-post" class="button radius-10"><?php esc_html_e( "Leave A Review", "embedpress" ); ?></a>
        </div>
    </div>
</div>
