...
jQuery(document).ready(function ($) {
    ...
    * */
    ...
    $(document).ready(function () {
        function copyToClipboard(selector, dataAttr, copyFor) {
            $(selector).click(function () {
                var eventLink = $(this).data(dataAttr);
                var tempInput = $('<input>');
                ...
                if (copyFor === 'fb_page') {
                    button.find('span').addClass('show-toast');

                    setTimeout(function () {
                        button.find('span').removeClass('show-toast');
                    }, 1500);
                }
                else {
        ...
        copyToClipboard('.calendly-event-copy-link', 'event-link', 'calendly');
        copyToClipboard('#fbPageLink span', 'fb-page-url', 'fb_page');
