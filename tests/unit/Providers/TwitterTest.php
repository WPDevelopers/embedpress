<?php
/**
 * Auto-generated test for Twitter provider (embera).
...
class TwitterTest extends TestCase
{
    ...
    {
        $this->assertTrue(class_exists('\Embera\Provider\Twitter'), 'Embera\Provider\Twitter class should exist');
    }

    public function test_provider_has_hosts(): void
    {
        $reflection = new \ReflectionClass('\Embera\Provider\Twitter');
        $hosts = $reflection->getStaticPropertyValue('hosts');
        $this->assertNotEmpty($hosts, 'Twitter should define hosts');
    }

    public function test_provider_can_be_instantiated(): void
    {
        $provider = new \Embera\Provider\Twitter('https://example.com');
        $this->assertInstanceOf('\Embera\Provider\Twitter', $provider);
    }
