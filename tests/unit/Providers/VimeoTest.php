<?php
/**
 * Auto-generated test for Vimeo provider (embera).
...
class VimeoTest extends TestCase
{
    ...
    {
        $this->assertTrue(class_exists('\Embera\Provider\Vimeo'), 'Embera\Provider\Vimeo class should exist');
    }

    public function test_provider_has_hosts(): void
    {
        $reflection = new \ReflectionClass('\Embera\Provider\Vimeo');
        $hosts = $reflection->getStaticPropertyValue('hosts');
        $this->assertNotEmpty($hosts, 'Vimeo should define hosts');
    }

    public function test_provider_can_be_instantiated(): void
    {
        $provider = new \Embera\Provider\Vimeo('https://example.com');
        $this->assertInstanceOf('\Embera\Provider\Vimeo', $provider);
    }
