<?php
/**
 * Auto-generated test for iFixit provider (embera).
...
class iFixitTest extends TestCase
{
    public function test_provider_class_exists(): void
    {
        $this->assertTrue(class_exists('\Embera\Provider\iFixit'), 'Embera\Provider\iFixit class should exist');
    }

    public function test_provider_has_hosts(): void
    {
        $reflection = new \ReflectionClass('\Embera\Provider\iFixit');
        $hosts = $reflection->getStaticPropertyValue('hosts');
        $this->assertNotEmpty($hosts, 'iFixit should define hosts');
    }

    public function test_provider_can_be_instantiated(): void
    {
        $provider = new \Embera\Provider\iFixit('https://example.com');
        $this->assertInstanceOf('\Embera\Provider\iFixit', $provider);
    }
