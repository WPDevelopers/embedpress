...
test.describe("Elementor Instagram Feed", () => {
    ...
    test('Default Instagram', async ({ page }) => {
        ...
        await page.locator('header').filter({ hasText: 'nahidwpd Follow 40 posts 0' }).click();
        await page.getByText('Md. Nahid Hasan').first().click();
        await page.locator('.insta-gallery-item-info').first().click();
