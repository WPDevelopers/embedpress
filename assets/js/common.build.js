(function() {
  ...
  (function($) {
    ...
    ready(function() {
      ...
      if (selector.length) {
        selector.forEach(function(value, index, thisArg) {
          ...
          PDFObject == null ? void 0 : PDFObject.embed(src, "." + id, option);
        });
      }
    ...
    if (!Element.prototype.matches) {
      Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.webkitMatchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || function(s) {
    ...
    function youtubeChannelEvents(playerWrap) {
      ...
      delegate(playerWrap, "click", ".ep-next, .ep-prev", function(event) {
        event.target.closest(".ose-youtube").getAttribute("data-total-pages");
        ...
        sendRequest(eplocalize.ajaxurl, formBody, function(request) {
          if (galleryWrapper && galleryWrapper[0] && request.responseText) {
            ...
            var currentPageNode = galleryWrapper[0].getElementsByClassName("current-page");
        ...
        const intervalID = setInterval(() => {
          ...
          if (playerWrap.querySelector(".ep-youtube__content__block")) {
            const newNearestEpContentId = playerWrap.querySelector(".ep-youtube__content__block").getAttribute("data-unique-id");
      ...
      jQuery.post(eplocalize.ajaxurl, data, function(response) {
        ...
        if (response.success) {
          if (!response.embedHtml) {
            ...
            (_b = (_a = document.querySelector("#" + perentSel + "-" + ep_client_id + " .ep-embed-content-wraper")) == null ? void 0 : _a.classList) == null ? void 0 : _b.remove("plyr-initialized");
            ...
            if (eplocalize.is_pro_plugin_active) {
              ...
              if (typeof adInitialization === "function") {
                adInitialization(adIdEl, adIdEl == null ? void 0 : adIdEl.getAttribute("data-ad-index"));
              }
            }
          }
        } else {
    ...
    epGlobals.instaPopup = (container) => {
      container == null ? void 0 : container.addEventListener("click", function(event) {
        ...
        if (instaItem) {
          ...
          const accountType = (_a = container == null ? void 0 : container.closest(".instagram-container")) == null ? void 0 : _a.getAttribute("data-connected-acc-type");
          let hashtag = "";
          if (instaItem.closest(".instagram-container").getAttribute("data-hashtag")) {
            hashtag = (_b = instaItem == null ? void 0 : instaItem.closest(".instagram-container")) == null ? void 0 : _b.getAttribute("data-hashtag");
          }
          const closestPopup = (_c = event.target.closest(".ose-instagram-feed")) == null ? void 0 : _c.querySelector(".insta-popup");
          if (closestPopup) {
          ...
          if (!((_d = document.querySelector(`#post-${postid}`)) == null ? void 0 : _d.classList.contains("carousel-is-initialized"))) {
            ...
            (_e = document.querySelector(`#post-${postid}`)) == null ? void 0 : _e.classList.add("carousel-is-initialized");
          }
        }
      });
    };
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    nextButton == null ? void 0 : nextButton.addEventListener("click", nextSlide);
    prevButton == null ? void 0 : prevButton.addEventListener("click", prevSlide);
  ...
  function presentationModeForIOS(iframes2) {
    iframes2 == null ? void 0 : iframes2.forEach(function(iframe) {
      iframe.onload = function() {
        var iframeDoc = iframe.contentDocument || iframe.contentWindow.document;
        var button = iframeDoc == null ? void 0 : iframeDoc.querySelector("#presentationMode.presentationMode");
        button == null ? void 0 : button.addEventListener("click", function() {
          iframe.classList.toggle("presentationModeEnabledIosDevice");
        });
        iframeDoc == null ? void 0 : iframeDoc.addEventListener("keydown", function(event) {
          if (event.keyCode === 27) {
    ...
    function fetchVideoData(videoId, videoIframe, videoDescriptionContainer) {
      ...
      $.post(embedpressFrontendData.ajaxUrl, data, function(response) {
        ...
        if (response.success) {
          ...
          console.error("Error fetching video data:", (_a = response == null ? void 0 : response.data) == null ? void 0 : _a.error);
        }
      });
    }
