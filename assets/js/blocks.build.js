...
const { useBlockProps: useBlockProps$r } = wp.blockEditor;
const { applyFilters: applyFilters$x } = wp.hooks;
function Save$a({ attributes: attributes2 }) {
  const blockProps = useBlockProps$r.save();
  const {
    url,
    embedHTML,
    width,
  ...
  const customLogoTemp = applyFilters$x("embedpress.customLogoComponent", "", attributes2);
...
function LockControl({ attributes: attributes2, setAttributes }) {
  ...
  const togglePlacehoder = applyFilters$w("embedpress.togglePlaceholder", [], "Enable Content Protection", false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$u, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    ...
    applyFilters$w("embedpress.toggleContentProtection", [togglePlacehoder], attributes2, setAttributes),
    applyFilters$w("embedpress.lockContentControllers", [], attributes2, setAttributes)
  ] });
}
...
function CustomBranding$1({ attributes: attributes2, setAttributes }) {
  ...
  const placeholder = applyFilters$v("embedpress.uploadPlaceholder", []);
  ...
  ] }), initialOpen: false, children: applyFilters$v("embedpress.customLogoSettings", [placeholder], attributes2, setAttributes) });
}
...
const CustomPlayerControls = (props) => {
  ...
  const tooltipPlaceholder = applyFilters$u("embedpress.togglePlaceholder", [], __$_("Tooltip", "embedpress"), true);
  const autoHideControlsPlaceholder = applyFilters$u("embedpress.togglePlaceholder", [], __$_("Auto Hide Controls", "embedpress"), true);
  const sourceLinkPlaceholder = applyFilters$u("embedpress.togglePlaceholder", [], __$_("Source Link", "embedpress"), true);
  const stickyVideoPlaceholder = applyFilters$u("embedpress.togglePlaceholder", [], __$_("Sticky Video", "embedpress"), false);
  const UploadPlaceholder = applyFilters$u("embedpress.uploadPlaceholder", [], __$_("Sticky Video", "embedpress"), false);
  const presetPlaceholder = applyFilters$u("embedpress.selectPlaceholder", [], __$_("Preset", "embedpress"), "default", "Default");
  const colorPlatePlaceholder = applyFilters$u("embedpress.colorPlatePlaceholder", [], __$_("Player Color", "embedpress"), "#5b4e96", colors$1);
  const autoPause = applyFilters$u("embedpress.togglePlaceholder", [], __$_("Auto Paause", "embedpress"), false);
  const dnt = applyFilters$u("embedpress.togglePlaceholder", [], __$_("DNT", "embedpress"), false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-custom-player-controls", children: [
    applyFilters$u("embedpress.youtubeControls", [presetPlaceholder], attributes2, setAttributes, "preset", props),
    ...
    applyFilters$u("embedpress.youtubeControls", [colorPlatePlaceholder], attributes2, setAttributes, "playerColor"),
    ...
    isVimeoVideo2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "vimeo-player-controls", children: [
      ...
      applyFilters$u("embedpress.vimeoControls", [autoPause], attributes2, setAttributes, "autoPause"),
      applyFilters$u("embedpress.vimeoControls", [dnt], attributes2, setAttributes, "dnt")
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$r,
      {
    ...
    applyFilters$u("embedpress.youtubeControls", [tooltipPlaceholder], attributes2, setAttributes, "tooltip"),
    applyFilters$u("embedpress.youtubeControls", [autoHideControlsPlaceholder], attributes2, setAttributes, "autoHide"),
    applyFilters$u("embedpress.youtubeControls", [sourceLinkPlaceholder], attributes2, setAttributes, "sourceLink"),
    applyFilters$u("embedpress.youtubeControls", [stickyVideoPlaceholder], attributes2, setAttributes, "stickyVideo"),
    ...
    !isSelfHostedAudio2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      applyFilters$u("embedpress.youtubeControls", UploadPlaceholder, attributes2, setAttributes, "thumbnail", props)
    ] })
  ] });
};
...
function Youtube({ attributes: attributes2, setAttributes, isYTChannel: isYTChannel2, isYTVideo: isYTVideo2, isYTLive: isYTLive2, isYTShorts: isYTShorts2 }) {
  ...
  const togglePlaceholder = applyFilters$t("embedpress.togglePlaceholder", [], __$Z("Closed Captions", "embedpress"), true);
  const selectPlaceholder = applyFilters$t("embedpress.selectPlaceholder", [], __$Z("Modest Branding", "embedpress"), "display", "Display");
...
function OpenSea({ attributes: attributes2, setAttributes, isOpensea: isOpensea2, isOpenseaSingle: isOpenseaSingle2 }) {
  ...
  applyFilters$r("embedpress.uploadPlaceholder", [], __$X("Sticky Video", "embedpress"), false);
  const creatorPrefixPlaceholder = applyFilters$r("embedpress.textControlPlaceholder", [], __$X("Creator Prefix", "embedpress"), "");
  const pricePrefixPlaceholder = applyFilters$r("embedpress.textControlPlaceholder", [], __$X("Price Prefix", "embedpress"), "");
  const lastSalePrefixPlaceholder = applyFilters$r("embedpress.textControlPlaceholder", [], __$X("Last Sale Prefix", "embedpress"), "");
  const buttonLabelPlaceholder = applyFilters$r("embedpress.textControlPlaceholder", [], __$X("Button Label", "embedpress"), "");
  const rankLabelPlaceholder = applyFilters$r("embedpress.textControlPlaceholder", [], __$X("Rank Label", "embedpress"), "");
  const detailsLabelPlaceholder = applyFilters$r("embedpress.textControlPlaceholder", [], __$X("Details Label", "embedpress"), "");
  const loadmorePlaceholder = applyFilters$r("embedpress.togglePlaceholder", [], __$X("Load More", "embedpress"), false);
...
function Wistia({ attributes: attributes2, setAttributes, isWistiaVideo: isWistiaVideo2 }) {
  ...
  const captionsPlaceholder = applyFilters$q("embedpress.togglePlaceholder", [], __$W("Captions", "embedpress"), true);
  const volumePlaceholder = applyFilters$q("embedpress.togglePlaceholder", [], __$W("Volume Control", "embedpress"), true);
  const volumeRangePlaceholder = applyFilters$q("embedpress.rangeControlPlaceholder", [], __$W("Volume"), 50, 0, 100, true);
...
const { addFilter: addFilter$7, applyFilters: applyFilters$p } = wp.hooks;
const {
...
function Vimeo({ attributes: attributes2, setAttributes, isVimeoVideo: isVimeoVideo2 }) {
  ...
  const loop = applyFilters$p("embedpress.togglePlaceholder", [], __$V("Loop", "embedpress"), false);
  const autoPause = applyFilters$p("embedpress.togglePlaceholder", [], __$V("Auto Paause", "embedpress"), false);
  const dnt = applyFilters$p("embedpress.togglePlaceholder", [], __$V("DNT", "embedpress"), false);
...
function Instafeed({ attributes: attributes2, setAttributes }) {
  ...
  const feedTabPlaceholder = applyFilters$o("embedpress.togglePlaceholder", [], __$T("Feed Tab", "embedpress"), false);
  const likesCountPlaceholder = applyFilters$o("embedpress.togglePlaceholder", [], __$T("Likes Count", "embedpress"), false);
  const commentsCountPlaceholder = applyFilters$o("embedpress.togglePlaceholder", [], __$T("Comments Count", "embedpress"), false);
...
function Calendly({ attributes: attributes2, setAttributes, isCalendly: isCalendly2 }) {
  ...
  const cDataPlaceholder = applyFilters$n("embedpress.togglePlaceholder", [], __$S("Calendly Data", "embedpress"), false);
...
function Spreaker({ attributes: attributes2, setAttributes }) {
  ...
  const hideDoownloadPlaceholder = applyFilters$m("embedpress.togglePlaceholder", [], __$R("Disable Download", "embedpress"), false);
  const playlistContinuousPlaceholder = applyFilters$m("embedpress.togglePlaceholder", [], __$R("Continuous Playlist", "embedpress"), false);
  const loopPlaylistPlaceholder = applyFilters$m("embedpress.togglePlaceholder", [], __$R("Loop Playlist", "embedpress"), false);
...
const { useBlockProps: useBlockProps$q, BlockControls: BlockControls$d } = wp.blockEditor;
...
function Edit$a(props) {
  ...
  const blockProps = useBlockProps$q();
...
function CustomBranding({ attributes: attributes2, setAttributes }) {
  ...
  const placeholder = applyFilters$j("embedpress.uploadPlaceholder", []);
  ...
  ] }), initialOpen: false, children: applyFilters$j("embedpress.customLogoSettings", [placeholder], attributes2, setAttributes) });
}
...
const DocControls = ({ attributes: attributes2, setAttributes }) => {
  ...
  const toolbarPlaceholder = applyFilters$i("embedpress.togglePlaceholder", [], __$I("Toolbar", "embedpress"), true);
  const printPlaceholder = applyFilters$i("embedpress.togglePlaceholder", [], __$I("Print/Download", "embedpress"), true);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$d, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    ...
    docViewer === "custom" && applyFilters$i("embedpress.documentControls", [toolbarPlaceholder], attributes2, setAttributes, "toolbar"),
    toolbar && docViewer === "custom" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Fragment$f, { children: [
      ...
      applyFilters$i("embedpress.documentControls", [printPlaceholder], attributes2, setAttributes, "print"),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$e,
        {
...
const { useBlockProps: useBlockProps$o, BlockIcon: BlockIcon$2, MediaPlaceholder: MediaPlaceholder$3, InspectorControls: InspectorControls$c, BlockControls: BlockControls$b } = wp.blockEditor;
...
const Edit$9 = ({ attributes: attributes2, mediaUpload, noticeOperations, isSelected, setAttributes, clientId, noticeUI }) => {
  ...
  const blockProps = useBlockProps$o();
  useEffect$d(() => {
    if (isBlobURL$1(href)) {
  ...
  const customLogoTemp = applyFilters$h("embedpress.customLogoComponent", "", attributes2);
...
const Save$9 = ({ attributes: attributes2, setAttributes }) => {
  const blockProps = useBlockProps$n.save();
  const {
    href,
    mime,
    id,
...
const { InspectorControls: InspectorControls$b, useBlockProps: useBlockProps$m, BlockControls: BlockControls$9 } = wp.blockEditor;
...
function Edit$8({ attributes: attributes2, className, setAttributes, isSelected }) {
  ...
  const blockProps = useBlockProps$m ? useBlockProps$m({
...
const Inspector$a = ({ attributes: attributes2, setAttributes }) => {
  ...
  const toobarPlaceholder = applyFilters$e("embedpress.togglePlaceholder", [], __$A("Toolbar", "embedpress"), true);
  const printPlaceholder = applyFilters$e("embedpress.togglePlaceholder", [], __$A("Print/Download", "embedpress"), true);
  const drawPlaceholder = applyFilters$e("embedpress.togglePlaceholder", [], __$A("Draw", "embedpress"), false);
  const copyPlaceholder = applyFilters$e("embedpress.togglePlaceholder", [], __$A("Copy Text", "embedpress"), true);
  const scrollingPlaceholder = applyFilters$e("embedpress.selectPlaceholder", [], __$A("Default Scrolling", "embedpress"), "-1", "Page Scrolling");
  const selectionPlaceholder = applyFilters$e("embedpress.selectPlaceholder", [], __$A("Default Selection Tool", "embedpress"), "0", "Text Tool");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(InspectorControls$a, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$a, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
      ...
      applyFilters$e("embedpress.pdfControls", [toobarPlaceholder], attributes2, setAttributes, "toolbar"),
      toolbar && /* @__PURE__ */ jsxRuntimeExports.jsxs(Fragment$b, { children: [
        ...
        applyFilters$e("embedpress.pdfControls", [printPlaceholder], attributes2, setAttributes, "print"),
        viewerStyle === "modern" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Fragment$b, { children: [
          ...
          applyFilters$e("embedpress.pdfControls", [drawPlaceholder], attributes2, setAttributes, "draw"),
          applyFilters$e("embedpress.pdfControls", [copyPlaceholder], attributes2, setAttributes, "copyText"),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToggleControl$b,
            {
          ...
          applyFilters$e("embedpress.pdfControls", [selectionPlaceholder], attributes2, setAttributes, "selectionTool"),
          applyFilters$e("embedpress.pdfControls", [scrollingPlaceholder], attributes2, setAttributes, "scrolling"),
