...
import { R as Root, A as AnimatedTheme, P as PieChart, p as percent, a as PieSeries, T as Tooltip$9, b as RoundedRectangle, c as p50, d as color, L as Label } from "./chunks/AnimatedTheme-BdfW43wT.js";
const {
  G,
  Path,
  Polygon,
...
const { useState: useState$r, useEffect: useEffect$s } = wp.element;
...
const CustomPlayerControls = (props) => {
  ...
  const tooltipPlaceholder = applyFilters$k("embedpress.togglePlaceholder", [], __$X("Tooltip", "embedpress"), true);
  const autoHideControlsPlaceholder = applyFilters$k("embedpress.togglePlaceholder", [], __$X("Auto Hide Controls", "embedpress"), true);
  const sourceLinkPlaceholder = applyFilters$k("embedpress.togglePlaceholder", [], __$X("Source Link", "embedpress"), true);
  const stickyVideoPlaceholder = applyFilters$k("embedpress.togglePlaceholder", [], __$X("Sticky Video", "embedpress"), false);
  const UploadPlaceholder = applyFilters$k("embedpress.uploadPlaceholder", [], __$X("Sticky Video", "embedpress"), false);
  const presetPlaceholder = applyFilters$k("embedpress.selectPlaceholder", [], __$X("Preset", "embedpress"), "default", "Default");
  const colorPlatePlaceholder = applyFilters$k("embedpress.colorPlatePlaceholder", [], __$X("Player Color", "embedpress"), "#5b4e96", colors$2);
  const autoPause = applyFilters$k("embedpress.togglePlaceholder", [], __$X("Auto Paause", "embedpress"), false);
  const dnt = applyFilters$k("embedpress.togglePlaceholder", [], __$X("DNT", "embedpress"), false);
...
function Youtube({ attributes: attributes2, setAttributes, isYTChannel: isYTChannel2, isYTVideo: isYTVideo2, isYTLive: isYTLive2, isYTShorts: isYTShorts2 }) {
  ...
  const togglePlaceholder = applyFilters$j("embedpress.togglePlaceholder", [], __$W("Closed Captions", "embedpress"), true);
  const selectPlaceholder = applyFilters$j("embedpress.selectPlaceholder", [], __$W("Modest Branding", "embedpress"), "display", "Display");
...
const { useState: useState$p, useEffect: useEffect$q, useRef: useRef$5 } = wp.element;
...
function OpenSea({ attributes: attributes2, setAttributes, isOpensea: isOpensea2, isOpenseaSingle: isOpenseaSingle2 }) {
  ...
  applyFilters$h("embedpress.uploadPlaceholder", [], __$U("Sticky Video", "embedpress"), false);
  const creatorPrefixPlaceholder = applyFilters$h("embedpress.textControlPlaceholder", [], __$U("Creator Prefix", "embedpress"), "");
  const pricePrefixPlaceholder = applyFilters$h("embedpress.textControlPlaceholder", [], __$U("Price Prefix", "embedpress"), "");
  const lastSalePrefixPlaceholder = applyFilters$h("embedpress.textControlPlaceholder", [], __$U("Last Sale Prefix", "embedpress"), "");
  const buttonLabelPlaceholder = applyFilters$h("embedpress.textControlPlaceholder", [], __$U("Button Label", "embedpress"), "");
  const rankLabelPlaceholder = applyFilters$h("embedpress.textControlPlaceholder", [], __$U("Rank Label", "embedpress"), "");
  const detailsLabelPlaceholder = applyFilters$h("embedpress.textControlPlaceholder", [], __$U("Details Label", "embedpress"), "");
  const loadmorePlaceholder = applyFilters$h("embedpress.togglePlaceholder", [], __$U("Load More", "embedpress"), false);
...
const { addFilter: addFilter$8, applyFilters: applyFilters$g } = wp.hooks;
const {
...
function Wistia({ attributes: attributes2, setAttributes, isWistiaVideo: isWistiaVideo2 }) {
  ...
  const captionsPlaceholder = applyFilters$g("embedpress.togglePlaceholder", [], __$T("Captions", "embedpress"), true);
  const volumePlaceholder = applyFilters$g("embedpress.togglePlaceholder", [], __$T("Volume Control", "embedpress"), true);
  const volumeRangePlaceholder = applyFilters$g("embedpress.rangeControlPlaceholder", [], __$T("Volume"), 50, 0, 100, true);
...
const { addFilter: addFilter$7, applyFilters: applyFilters$f } = wp.hooks;
const {
...
function Vimeo({ attributes: attributes2, setAttributes, isVimeoVideo: isVimeoVideo2 }) {
  ...
  const loop = applyFilters$f("embedpress.togglePlaceholder", [], __$S("Loop", "embedpress"), false);
  const autoPause = applyFilters$f("embedpress.togglePlaceholder", [], __$S("Auto Paause", "embedpress"), false);
  const dnt = applyFilters$f("embedpress.togglePlaceholder", [], __$S("DNT", "embedpress"), false);
...
function Instafeed({ attributes: attributes2, setAttributes }) {
  ...
  const feedTabPlaceholder = applyFilters$e("embedpress.togglePlaceholder", [], __$Q("Feed Tab", "embedpress"), false);
  const likesCountPlaceholder = applyFilters$e("embedpress.togglePlaceholder", [], __$Q("Likes Count", "embedpress"), false);
  const commentsCountPlaceholder = applyFilters$e("embedpress.togglePlaceholder", [], __$Q("Comments Count", "embedpress"), false);
...
function Calendly({ attributes: attributes2, setAttributes, isCalendly: isCalendly2 }) {
  ...
  const cDataPlaceholder = applyFilters$d("embedpress.togglePlaceholder", [], __$P("Calendly Data", "embedpress"), false);
...
const { addFilter: addFilter$3, applyFilters: applyFilters$c } = wp.hooks;
const {
...
function Spreaker({ attributes: attributes2, setAttributes }) {
  ...
  const hideDoownloadPlaceholder = applyFilters$c("embedpress.togglePlaceholder", [], __$O("Disable Download", "embedpress"), false);
  const playlistContinuousPlaceholder = applyFilters$c("embedpress.togglePlaceholder", [], __$O("Continuous Playlist", "embedpress"), false);
  const loopPlaylistPlaceholder = applyFilters$c("embedpress.togglePlaceholder", [], __$O("Loop Playlist", "embedpress"), false);
...
const { useLayoutEffect, useRef: useRef$3, useState: useState$f, useEffect: useEffect$g } = wp.element;
...
const { Fragment: Fragment2$1, useEffect: useEffect$e } = wp.element;
...
function Edit$9(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Fragment2$1, { children: [
    ...
    (!embedHTML || !!editingURL) && !fetching && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ...blockProps, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmbedPlaceholder,
      {
        label: __$I("EmbedPress - Embed anything from 150+ sites", "embedpress"),
        onSubmit: embed,
        value: url,
        cannotEmbed,
...
const DocControls = ({ attributes: attributes2, setAttributes }) => {
  ...
  const toolbarPlaceholder = applyFilters$8("embedpress.togglePlaceholder", [], __$F("Toolbar", "embedpress"), true);
  const printPlaceholder = applyFilters$8("embedpress.togglePlaceholder", [], __$F("Print/Download", "embedpress"), true);
...
const { TextControl: TextControl$8, PanelBody: PanelBody$a, ToggleControl: ToggleControl$8, ToolbarButton: ToolbarButton$8 } = wp.components;
