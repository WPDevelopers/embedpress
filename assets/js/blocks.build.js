...
const { BlockControls: BlockControls$b } = wp.blockEditor;
...
const { Fragment: Fragment$f, useEffect: useEffect$f } = wp.element;
...
const { useBlockProps: useBlockProps$l, BlockIcon: BlockIcon$2, MediaPlaceholder: MediaPlaceholder$2, InspectorControls: InspectorControls$b, BlockControls: BlockControls$9 } = wp.blockEditor;
...
const Edit$8 = ({ attributes: attributes2, mediaUpload, noticeOperations, isSelected, setAttributes, clientId, noticeUI }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ...blockProps, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(BlockControls$9, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToolbarButton$9,
      {
        icon: "edit",
