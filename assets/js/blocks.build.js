...
const CustomPlayerAdvancedPanels = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$s, { title: titleWithIcon(__$$("Navigation & UX", "embedpress")), initialOpen: false, children: [
      f(chaptersPlaceholder, "chapters"),
      f(autoResumePlaceholder, "autoResume"),
      f(endScreenPlaceholder, "endScreen")
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$s, { title: titleWithIcon(__$$("Privacy & Compliance", "embedpress")), initialOpen: false, children: [
      f(privacyModePlaceholder, "privacyMode"),
      f(countryRestrictionPlaceholder, "countryRestriction")
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$s, { title: titleWithIcon(__$$("Analytics & Learning", "embedpress")), initialOpen: false, children: [
      f(heatmapPlaceholder, "heatmap"),
      f(lmsTrackingPlaceholder, "lmsTracking")
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$s, { title: titleWithIcon(__$$("Delivery", "embedpress")), initialOpen: false, children: [
...
function Youtube({ attributes: attributes2, setAttributes, isYTChannel: isYTChannel2, isYTVideo: isYTVideo2, isYTLive: isYTLive2, isYTShorts: isYTShorts2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    (isYTVideo2 || isYTLive2 || isYTShorts2) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep__single-yt-video-options", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$r, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
        EPIcon,
        " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CustomPlayerAdvancedPanels, { attributes: attributes2, setAttributes, isYTVideo: isYTVideo2, isYTLive: isYTLive2 })
    ] })
  ] });
}
...
function SelfHosted({ attributes: attributes2, setAttributes }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: (isSelfHostedVideo(url) || isSelfHostedAudio(url)) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep__vimeo-video-options", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CustomPlayerAdvancedPanels, { attributes: attributes2, setAttributes, isSelfHostedVideo: _isSelfHostedVideo, isSelfHostedAudio: _isSelfHostedAudio })
  ] }) });
}
