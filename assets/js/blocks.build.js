...
const getPlayerOptions = ({ attributes: attributes2 }) => {
  const { customPlayer, cinematicPreview } = attributes2;
...
function Save$a({ attributes: attributes2 }) {
  ...
  const cinematicPreview = !!attributes2.cinematicPreview;
  const needsPlayerOptions = customPlayer || cinematicPreview;
  const playerOptionsRaw = needsPlayerOptions ? getPlayerOptions({ attributes: attributes2 }) : "";
...
const {
  ...
  ToggleControl: ToggleControl$u,
  PanelBody: PanelBody$v
} = wp.components;
function LockControl({ attributes: attributes2, setAttributes }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$v, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    EPIcon,
    " ",
...
const { __: __$13 } = wp.i18n;
const {
  TextControl: TextControl$t,
...
function ContentShare$1({ attributes: attributes2, setAttributes }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$t, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "content-share-toggle", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$t,
      {
        label: __$12("Enable Social Share"),
    ...
    contentShare && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content-share-controls", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextControl$s,
        {
          ...
          placeholder: __$12("Enter Title")
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextareaControl,
        {
          label: __$12("Description"),
          placeholder: __$12("Enter description"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: __$12("Share Platforms", "embedpress") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$t,
        {
          label: __$12("Facebook"),
...
const { useState: useState$t, useEffect: useEffect$v } = wp.element;
const { isShallowEqualObjects: isShallowEqualObjects$b } = wp.isShallowEqual;
...
function CustomBranding$1({ attributes: attributes2, setAttributes }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PanelBody$s, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    EPIcon,
    " ",
...
const CustomPlayerControls = (props) => {
  ...
  applyFilters$v("embedpress.togglePlaceholder", [], __$10("Cinematic Preview", "embedpress"), false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-custom-player-controls", children: [
    ...
    (isYTLive2 || isYTVideo2 || isYTShorts2) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "youtube-player-controls", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextControl$q,
        {
          label: __$10("Start Time (in seconds)"),
          value: starttime,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextControl$q,
        {
          label: __$10("End Time (in seconds)"),
          value: endtime,
...
const useYTChannel = (attributes2) => {
  ...
  const [atts, setAtts] = useState$s(param);
  useEffect$u(() => {
    const param2 = getParams(atts, attributes2, defaults);
    if (!isShallowEqualObjects$a(atts || {}, param2)) {
      setAtts(param2);
    }
  }, [attributes2]);
  return atts;
...
function Youtube({ attributes: attributes2, setAttributes, isYTChannel: isYTChannel2, isYTVideo: isYTVideo2, isYTLive: isYTLive2, isYTShorts: isYTShorts2 }) {
  ...
  const togglePlaceholder = applyFilters$u("embedpress.togglePlaceholder", [], __$$("Closed Captions", "embedpress"), true);
  const selectPlaceholder = applyFilters$u("embedpress.selectPlaceholder", [], __$$("Modest Branding", "embedpress"), "display", "Display");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    (isYTVideo2 || isYTLive2 || isYTShorts2) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ep__single-yt-video-options", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$r, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
      EPIcon,
      " ",
      __$$("Video Controls", "embedpress")
    ] }), initialOpen: false, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$r,
        {
...
const { useState: useState$r, useEffect: useEffect$t, useRef: useRef$7 } = wp.element;
const AdTemplate = ({ attributes: attributes2, setAttributes, deleteIcon, inEditor, progressBar }) => {
  ...
  const [showSkipButton, setShowSkipButton] = useState$r(false);
  const [currentTime, setCurrentTime] = useState$r(0);
...
function OpenSea({ attributes: attributes2, setAttributes, isOpensea: isOpensea2, isOpenseaSingle: isOpenseaSingle2 }) {
  ...
  applyFilters$s("embedpress.uploadPlaceholder", [], __$Z("Sticky Video", "embedpress"), false);
  const creatorPrefixPlaceholder = applyFilters$s("embedpress.textControlPlaceholder", [], __$Z("Creator Prefix", "embedpress"), "");
  const pricePrefixPlaceholder = applyFilters$s("embedpress.textControlPlaceholder", [], __$Z("Price Prefix", "embedpress"), "");
  const lastSalePrefixPlaceholder = applyFilters$s("embedpress.textControlPlaceholder", [], __$Z("Last Sale Prefix", "embedpress"), "");
  const buttonLabelPlaceholder = applyFilters$s("embedpress.textControlPlaceholder", [], __$Z("Button Label", "embedpress"), "");
  const rankLabelPlaceholder = applyFilters$s("embedpress.textControlPlaceholder", [], __$Z("Rank Label", "embedpress"), "");
  const detailsLabelPlaceholder = applyFilters$s("embedpress.textControlPlaceholder", [], __$Z("Details Label", "embedpress"), "");
  const loadmorePlaceholder = applyFilters$s("embedpress.togglePlaceholder", [], __$Z("Load More", "embedpress"), false);
  return (isOpensea2 || isOpenseaSingle2) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    isOpensea2 && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelBody$p, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SelectControl$g,
        {
          label: __$Z("Order By", "embedpress"),
          value: orderby,
          options: [
    ...
    isOpensea2 && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelBody$p, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        RangeControl$f,
        {
          label: __$Z("Item Per Row", "embedpress"),
          value: nftperrow || 3,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        RangeControl$f,
        {
          label: __$Z("Gap Between Item", "embedpress"),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$p,
        {
          label: __$Z("Thumbnail", "embedpress"),
          checked: nftimage,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$p,
        {
          label: __$Z("Show Price", "embedpress"),
          checked: nftprice,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$p,
        {
          label: __$Z("Last Sale", "embedpress"),
          checked: nftlastsale,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$p,
        {
          label: __$Z("Show Button", "embedpress"),
          checked: nftbutton,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
      EPIcon,
      " ",
      __$Z("Color and Typography", "embedpress")
    ] }), initialOpen: false, className: "ep-colors-typography", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: __$Z("You can adjust the color and typography of embedded content.") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-opensea-sub-controls", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: __$Z("Item"), initialOpen: false, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ControlHeader, { headerText: "Background Color" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ColorPalette$c,
            {
              label: __$Z("Background Color"),
              colors: colors2,
              value: itemBGColor,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: __$Z("Collection Name"), initialOpen: false, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: __$Z("Title"), initialOpen: false, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ControlHeader, { headerText: "Color" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ColorPalette$c,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: __$Z("Creator"), initialOpen: false, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ControlHeader, { headerText: "Color" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ColorPalette$c,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: __$Z("Current Price"), initialOpen: false, children: [
          isOpenseaSingle2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: __$Z("Last Sale Price"), initialOpen: false, children: [
          isOpenseaSingle2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ControlHeader, { headerText: "Label Color" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ColorPalette$c,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: __$Z("Button"), initialOpen: false, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ControlHeader, { headerText: "Color" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ColorPalette$c,
            {
        ...
        isOpenseaSingle2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: __$Z("Rank"), initialOpen: false, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ControlHeader, { headerText: "Label Color" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ColorPalette$c,
            {
              label: __$Z("Label Color"),
              colors: colors2,
        ...
        isOpenseaSingle2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$p, { title: __$Z("Details"), initialOpen: false, children: [
...
const { addFilter: addFilter$9, applyFilters: applyFilters$r } = wp.hooks;
const {
...
function Wistia({ attributes: attributes2, setAttributes, isWistiaVideo: isWistiaVideo2 }) {
  ...
  const captionsPlaceholder = applyFilters$r("embedpress.togglePlaceholder", [], __$Y("Captions", "embedpress"), true);
  const volumePlaceholder = applyFilters$r("embedpress.togglePlaceholder", [], __$Y("Volume Control", "embedpress"), true);
  const volumeRangePlaceholder = applyFilters$r("embedpress.rangeControlPlaceholder", [], __$Y("Volume"), 50, 0, 100, true);
...
const { addFilter: addFilter$8, applyFilters: applyFilters$q } = wp.hooks;
const {
...
function Vimeo({ attributes: attributes2, setAttributes, isVimeoVideo: isVimeoVideo2 }) {
  ...
  const loop = applyFilters$q("embedpress.togglePlaceholder", [], __$X("Loop", "embedpress"), false);
  const autoPause = applyFilters$q("embedpress.togglePlaceholder", [], __$X("Auto Paause", "embedpress"), false);
  const dnt = applyFilters$q("embedpress.togglePlaceholder", [], __$X("DNT", "embedpress"), false);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: isVimeoVideo2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ep__vimeo-video-options", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$n, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    EPIcon,
    " ",
    __$X("Video Controls", "embedpress")
  ] }), initialOpen: false, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$n,
      {
        label: __$X("Enable Custom Player", "embedpress"),
        checked: customPlayer,
        onChange: (customPlayer2) => setAttributes({ customPlayer: customPlayer2 })
      }
    ),
...
function SelfHosted({ attributes: attributes2, setAttributes }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: (isSelfHostedVideo(url) || isSelfHostedAudio(url)) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ep__vimeo-video-options", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$m, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    EPIcon,
    " ",
    __$W(panelTitle, "embedpress")
  ] }), initialOpen: false, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$m,
      {
        label: __$W("Auto-Pause", "embedpress"),
        checked: autoPause,
...
function Instafeed({ attributes: attributes2, setAttributes }) {
  ...
  const feedTabPlaceholder = applyFilters$p("embedpress.togglePlaceholder", [], __$V("Feed Tab", "embedpress"), false);
  const likesCountPlaceholder = applyFilters$p("embedpress.togglePlaceholder", [], __$V("Likes Count", "embedpress"), false);
  const commentsCountPlaceholder = applyFilters$p("embedpress.togglePlaceholder", [], __$V("Comments Count", "embedpress"), false);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: _isInstagramFeed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep__instafeed-options", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$l, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
      EPIcon,
      " ",
      __$V("Profile Settings", "embedpress")
    ] }), initialOpen: false, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$l,
        {
          label: __$V("Profile Image", "embedpress"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$l,
        {
          label: __$V("Follow Button", "embedpress"),
      ...
      instafeedFollowBtn && /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextControl$j,
        {
          label: __$V("Button Label", "embedpress"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$l,
        {
          label: __$V("Posts Count", "embedpress"),
      ...
      instafeedPostsCount && /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextControl$j,
        {
          label: __$V("Count Text", "embedpress"),
      ...
      instafeedAccountType === "business" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$l,
        {
          label: __$V("Followers Count", "embedpress"),
      ...
      instafeedAccountType === "business" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$l,
        {
          label: __$V("Account Name", "embedpress"),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PanelBody$l, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
      ...
      (instaLayout === "insta-grid" || instaLayout === "insta-masonry") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TextControl$j,
          {
            label: __$V("Column Gap", "embedpress"),
      ...
      instaLayout === "insta-carousel" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SelectControl$c,
          {
            label: __$V("Slides to Show", "embedpress"),
            value: slidesShow,
            options: [
              { label: "1", value: "1" },
              { label: "2", value: "2" },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ToggleControl$l,
          {
            label: __$V("Autoplay", "embedpress"),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TextControl$j,
          {
            label: __$V("Autoplay Speed(ms)", "embedpress"),
            value: autoplaySpeed,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TextControl$j,
          {
            label: __$V("Transition Speed(ms)", "embedpress"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextControl$j,
        {
          label: __$V("Posts Per Page", "embedpress"),
      ...
      instafeedPopup && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ToggleControl$l,
          {
            label: __$V("Popup Follow Button", "embedpress"),
        ...
        instafeedPopupFollowBtn && /* @__PURE__ */ jsxRuntimeExports.jsx(
          TextControl$j,
          {
            label: __$V("Follow Button Label", "embedpress"),
      ...
      (instaLayout === "insta-grid" || instaLayout === "insta-masonry") && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$l,
        {
          label: __$V("Load More", "embedpress"),
      ...
      instafeedLoadmore && /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextControl$j,
        {
          label: __$V("Load More Button Label", "embedpress"),
...
function Calendly({ attributes: attributes2, setAttributes, isCalendly: isCalendly2 }) {
  ...
  const cDataPlaceholder = applyFilters$o("embedpress.togglePlaceholder", [], __$U("Calendly Data", "embedpress"), false);
  return isCalendly2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PanelBody$k, { title: __$U("Calendly Controls"), initialOpen: false, className: "ep-calendly-options", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SelectControl$b,
        {
          label: __$U("Embed Type", "embedpress"),
          value: cEmbedType,
          options: [
      ...
      calendlyData && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-calendly-data-link", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/wp-admin/admin.php?page=embedpress&page_type=calendly", target: "_blank", children: [
          " ",
          __$U("View Calendly Data", "embedpress"),
          " "
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: cEmbedType === "popup_button" && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelBody$k, { title: __$U("Popup Settings"), initialOpen: false, className: "ep-calendly-options", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextControl$i,
        {
          label: "Button Text",
...
const { addFilter: addFilter$4, applyFilters: applyFilters$n } = wp.hooks;
const {
...
function Spreaker({ attributes: attributes2, setAttributes }) {
  ...
  const hideDoownloadPlaceholder = applyFilters$n("embedpress.togglePlaceholder", [], __$T("Disable Download", "embedpress"), false);
  const playlistContinuousPlaceholder = applyFilters$n("embedpress.togglePlaceholder", [], __$T("Continuous Playlist", "embedpress"), false);
  const loopPlaylistPlaceholder = applyFilters$n("embedpress.togglePlaceholder", [], __$T("Loop Playlist", "embedpress"), false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: isSpreakerUrl(url) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ep__vimeo-video-options", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$j, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    EPIcon,
    " ",
    __$T("Spreaker Controls", "embedpress")
  ] }), initialOpen: false, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SelectControl$a,
      {
        label: __$T("Theme", "embedpress"),
        value: theme,
        options: [
          { label: __$T("Light", "embedpress"), value: "light" },
          { label: __$T("Dark", "embedpress"), value: "dark" }
        ],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$j,
      {
        label: __$T("Enable Playlist", "embedpress"),
        help: __$T("This option is for podcast playlists and doesn’t affect individual episodes.", "embedpress"),
        checked: playlist,
    ...
    playlist && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$j,
        {
          label: __$T("Playlist Autoupdate", "embedpress"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$j,
        {
          label: __$T("Hide Playlist Descriptions", "embedpress"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$j,
        {
          label: __$T("Hide Playlist Images", "embedpress"),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SelectControl$a,
      {
        label: __$T("Episode Image Position", "embedpress"),
        value: episodeImagePosition,
        options: [
          { label: __$T("Right", "embedpress"), value: "right" },
          { label: __$T("Left", "embedpress"), value: "left" }
        ],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$j,
      {
        label: __$T("Show Chapters Images", "embedpress"),
        checked: chaptersImage,
        onChange: (chaptersImage2) => setAttributes({ chaptersImage: chaptersImage2 }),
        help: __$T("Only applies if the podcast includes chapter images.", "embedpress")
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$j,
      {
        label: __$T("Hide Likes", "embedpress"),
        checked: hideLikes,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$j,
      {
        label: __$T("Hide Comments", "embedpress"),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$j,
      {
        label: __$T("Hide Sharing", "embedpress"),
        checked: hideSharing,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$j,
      {
        label: __$T("Hide Logo", "embedpress"),
        checked: hideLogo,
        onChange: (hideLogo2) => setAttributes({ hideLogo: hideLogo2 }),
        help: __$T("Hide the Spreaker logo and branding in the player. Requires Broadcaster plan or higher.", "embedpress")
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$j,
      {
        label: __$T("Hide Episode Description", "embedpress"),
...
const { addFilter: addFilter$3, applyFilters: applyFilters$m } = wp.hooks;
...
function Twitch({ attributes: attributes2, setAttributes, isTwitch }) {
  const {
    twitchAutoplay,
    twitchMute,
    twitchTheme,
  ...
  const chatPlaceholder = applyFilters$m(
    ...
    [],
    __$S("Show Chat", "embedpress"),
    twitchChat,
    true
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: isTwitch && /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$i, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    EPIcon,
    " ",
    __$S("Twitch Controls", "embedpress")
  ] }), initialOpen: false, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      TextControl$g,
      {
        label: __$S("Start Time (in seconds)", "embedpress"),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$i,
      {
        label: __$S("Auto Play", "embedpress"),
        checked: twitchAutoplay,
        onChange: (twitchAutoplay2) => setAttributes({ twitchAutoplay: twitchAutoplay2 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$i,
      {
        label: __$S("Mute On Start", "embedpress"),
        checked: twitchMute,
        onChange: (twitchMute2) => setAttributes({ twitchMute: twitchMute2 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SelectControl$9,
      {
        label: __$S("Theme", "embedpress"),
        value: twitchTheme,
        options: [
          { label: __$S("Dark", "embedpress"), value: "dark" },
          { label: __$S("Light", "embedpress"), value: "light" }
        ],
        onChange: (twitchTheme2) => setAttributes({ twitchTheme: twitchTheme2 }),
        className: "ep-select-control-field",
        __nextHasNoMarginBottom: true
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$i,
      {
        label: __$S("Fullscreen Button", "embedpress"),
...
function GooglePhotos({ attributes: attributes2, setAttributes }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: isGooglePhotosUrl(url) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ep__google-photos-options", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$h, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
    EPIcon,
    " ",
    __$R("GooglePhotos Controls", "embedpress")
  ] }), initialOpen: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SelectControl$8,
      {
        label: __$R("Album Mode", "embedpress"),
        value: mode,
        options: [
          { label: __$R("Carousel", "embedpress"), value: "carousel" },
          { label: __$R("Gallery Player", "embedpress"), value: "gallery-player" },
          { label: __$R("Grid" + proLabel, "embedpress"), value: "gallery-grid" },
          { label: __$R("Masonry " + proLabel, "embedpress"), value: "gallery-masonary" },
          { label: __$R("Justify " + proLabel, "embedpress"), value: "gallery-justify" }
        ],
        onChange: (mode2) => {
    ...
    mode == "gallery-player" && /* @__PURE__ */ jsxRuntimeExports.jsxs("frameElement", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$h,
        {
          label: __$R("Autoplay", "embedpress"),
    ...
    mode == "gallery-player" || mode == "carousel" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ColorPalette$5,
      {
        label: __$R("Background Color", "embedpress"),
        colors: colors2,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      RangeControl$8,
      {
        label: __$R("Sync after (minutes)", "embedpress"),
        value: expiration,
    ...
    (mode === "gallery-player" || mode === "carousel") && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$h,
      {
        label: __$R("Enable Visit Google Photos Link", "embedpress"),
        checked: photos_link,
        onChange: (val) => setAttributes({ photos_link: val }),
        help: __$R("Enable an external link icon to visit the original Google Photos album", "embedpress")
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleControl$h,
      {
        label: __$R("Show Title", "embedpress"),
        checked: showTitle,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    PanelBody$g,
    {
      title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
        EPIcon,
        " ",
        __$Q("Meetup Settings", "embedpress")
      ] }),
      initialOpen: false,
      children: [
        isMeetupRssFeed && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectControl$7,
            {
              label: __$Q("Order By", "embedpress"),
              value: meetupOrderBy,
              options: [
                { label: __$Q("Date", "embedpress"), value: "date" },
                { label: __$Q("Title", "embedpress"), value: "title" },
                { label: __$Q("Attendees", "embedpress"), value: "attendees" }
              ],
              onChange: (meetupOrderBy2) => setAttributes({ meetupOrderBy: meetupOrderBy2 }),
              help: __$Q("Choose how to sort the events", "embedpress"),
              __nextHasNoMarginBottom: true
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectControl$7,
            {
              label: __$Q("Order", "embedpress"),
              value: meetupOrder,
              options: [
                { label: __$Q("Ascending", "embedpress"), value: "ASC" },
                { label: __$Q("Descending", "embedpress"), value: "DESC" }
              ],
              onChange: (meetupOrder2) => setAttributes({ meetupOrder: meetupOrder2 }),
              help: __$Q("Sort direction", "embedpress"),
              __nextHasNoMarginBottom: true
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            RangeControl$7,
            {
              label: __$Q("Events Per Page", "embedpress"),
              value: meetupPerPage,
              onChange: (meetupPerPage2) => setAttributes({ meetupPerPage: meetupPerPage2 }),
              min: 1,
              max: 50,
              step: 1,
              help: __$Q("Number of events to show per page", "embedpress")
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToggleControl$g,
            {
              label: __$Q("Enable Load More", "embedpress"),
              ...
              help: __$Q('Show a "Load More" button to load additional events', "embedpress")
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SelectControl$7,
          {
            label: __$Q("Timezone", "embedpress"),
            value: meetupTimezone,
            options: [
              { label: __$Q("Visitor Timezone (Auto-detect)", "embedpress"), value: "visitor_timezone" },
              { label: __$Q("WordPress Site Timezone", "embedpress"), value: "wp_timezone" },
              { label: __$Q("UTC", "embedpress"), value: "UTC" },
              { label: __$Q("America/New_York (EST/EDT)", "embedpress"), value: "America/New_York" },
              { label: __$Q("America/Chicago (CST/CDT)", "embedpress"), value: "America/Chicago" },
              { label: __$Q("America/Denver (MST/MDT)", "embedpress"), value: "America/Denver" },
              { label: __$Q("America/Los_Angeles (PST/PDT)", "embedpress"), value: "America/Los_Angeles" },
              { label: __$Q("Europe/London (GMT/BST)", "embedpress"), value: "Europe/London" },
              { label: __$Q("Europe/Paris (CET/CEST)", "embedpress"), value: "Europe/Paris" },
              { label: __$Q("Asia/Tokyo (JST)", "embedpress"), value: "Asia/Tokyo" },
              { label: __$Q("Australia/Sydney (AEST/AEDT)", "embedpress"), value: "Australia/Sydney" }
            ],
            onChange: (meetupTimezone2) => setAttributes({ meetupTimezone: meetupTimezone2 }),
            help: __$Q("Select timezone for displaying event dates and times. Visitor timezone will auto-detect based on their browser.", "embedpress"),
            __nextHasNoMarginBottom: true
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SelectControl$7,
          {
            label: __$Q("Date Format", "embedpress"),
            value: meetupDateFormat,
            options: [
              { label: __$Q("WordPress Date Format", "embedpress"), value: "wp_date_format" },
              { label: __$Q("MM/DD/YYYY", "embedpress"), value: "m/d/Y" },
              { label: __$Q("DD/MM/YYYY", "embedpress"), value: "d/m/Y" },
              { label: __$Q("YYYY-MM-DD", "embedpress"), value: "Y-m-d" },
              { label: __$Q("Month DD, YYYY", "embedpress"), value: "F j, Y" },
              { label: __$Q("DD Month YYYY", "embedpress"), value: "j F Y" }
            ],
            onChange: (meetupDateFormat2) => setAttributes({ meetupDateFormat: meetupDateFormat2 }),
            help: __$Q("Select date format for event dates", "embedpress"),
            __nextHasNoMarginBottom: true
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SelectControl$7,
          {
            label: __$Q("Time Format", "embedpress"),
            value: meetupTimeFormat,
            options: [
              { label: __$Q("WordPress Time Format", "embedpress"), value: "wp_time_format" },
              { label: __$Q("12-hour (h:mm AM/PM)", "embedpress"), value: "g:i A" },
              { label: __$Q("24-hour (HH:mm)", "embedpress"), value: "H:i" }
            ],
            onChange: (meetupTimeFormat2) => setAttributes({ meetupTimeFormat: meetupTimeFormat2 }),
            help: __$Q("Select time format for event times", "embedpress"),
            __nextHasNoMarginBottom: true
          }
        )
      ]
...
const CinematicPreviewControls = (props) => {
  const { attributes: attributes2, setAttributes, isSelfHostedAudio: isSelfHostedAudio2 } = props;
  if (isSelfHostedAudio2) return null;
  const cinematicPreviewPlaceholder = applyFilters$l(
    "embedpress.togglePlaceholder",
    [],
    __$P("Cinematic Preview", "embedpress"),
    false
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-cinematic-preview-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ControlHeader, { headerText: __$P("Cinematic Preview", "embedpress") }),
    applyFilters$l(
...
function Inspector$c({ attributes: attributes2, setAttributes, isYTChannel: isYTChannel2, isYTVideo: isYTVideo2, isYTLive: isYTLive2, isYTShorts: isYTShorts2, isOpensea: isOpensea2, isOpenseaSingle: isOpenseaSingle2, isWistiaVideo: isWistiaVideo2, isVimeoVideo: isVimeoVideo2, isSelfHostedVideo: isSelfHostedVideo2, isSelfHostedAudio: isSelfHostedAudio2, isCalendly: isCalendly2, isTikTok: isTikTok2, isSpreaker, isTwitch, isMeetup }) {
  ...
  return !editingURL && embedHTML && /* @__PURE__ */ jsxRuntimeExports.jsxs(InspectorControls$e, { children: [
    !isOpensea2 && !isOpenseaSingle2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "embedpress-gutenberg-controls", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Twitch, { attributes: attributes2, setAttributes, isTwitch }),
      ...
      (isYTVideo2 || isYTLive2 || isYTShorts2 || isVimeoVideo2 || isWistiaVideo2 || isSelfHostedVideo2 || isTwitch) && /* @__PURE__ */ jsxRuntimeExports.jsx(PanelBody$f, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
        EPIcon,
        " ",
        __$O("Cinematic Preview", "embedpress")
      ] }), initialOpen: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        CinematicPreviewControls,
        {
          attributes: attributes2,
          setAttributes,
          isSelfHostedAudio: isSelfHostedAudio2
        }
      ) }),
...
function Edit$a(props) {
  ...
  const twitchParams = useTwitch(attributes2);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("figure", { ...blockProps, "data-source-id": "source-" + attributes2.clientId, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `gutenberg-block-wraper ${contentShareClass} ${sharePositionClass}${sourceClass}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          EmbedWrap,
          {
            ...
            ...customPlayer || attributes2.cinematicPreview ? { "data-options": getPlayerOptions({ attributes: attributes2 }) } : {},
...
const { PanelBody: PanelBody$d, ToggleControl: ToggleControl$e, SelectControl: SelectControl$5, TextControl: TextControl$c, ColorPalette: ColorPalette$4 } = wp.components;
...
const { TextControl: TextControl$a, PanelBody: PanelBody$b, ToggleControl: ToggleControl$c, ToolbarButton: ToolbarButton$9 } = wp.components;
...
const { PanelBody: PanelBody$8, TextControl: TextControl$7, RadioControl: RadioControl$7, ToggleControl: ToggleControl$9, Tooltip: Tooltip$5 } = wp.components;
...
const { PanelBody: PanelBody$7, TextControl: TextControl$6, RadioControl: RadioControl$6, ToggleControl: ToggleControl$8, Tooltip: Tooltip$4 } = wp.components;
...
const { PanelBody: PanelBody$6, TextControl: TextControl$5, RadioControl: RadioControl$5, ToggleControl: ToggleControl$7, Tooltip: Tooltip$3 } = wp.components;
...
const { PanelBody: PanelBody$5, TextControl: TextControl$4, RadioControl: RadioControl$4, ToggleControl: ToggleControl$6, Tooltip: Tooltip$2 } = wp.components;
...
const { PanelBody: PanelBody$4, TextControl: TextControl$3, RadioControl: RadioControl$3, ToggleControl: ToggleControl$5, Tooltip: Tooltip$1 } = wp.components;
...
const { PanelBody: PanelBody$3, TextControl: TextControl$2, RadioControl: RadioControl$2, ToggleControl: ToggleControl$4, Tooltip } = wp.components;
...
const save$2 = (props) => {
  ...
  if (startTime > 0) {
    const ta = new Date(startTime * 1e3);
...
const { PanelBody: PanelBody$2, RangeControl: RangeControl$3, RadioControl: RadioControl$1, ToggleControl: ToggleControl$3, SelectControl: SelectControl$1, TextControl: TextControl$1 } = wp.components;
...
const Inspector$2 = ({ attributes: attributes2, setAttributes }) => {
  ...
  typeof embedpressGutenbergData !== "undefined" && embedpressGutenbergData.isProPluginActive;
  ...
  const chatPlaceholder = applyFilters$3(
    "embedpress.togglePlaceholder",
    [],
    __$c("Show Chat", "embedpress"),
    twitchChat,
    true
  );
  const min = 1;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(InspectorControls$2, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelBody$2, { title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ep-pannel-icon", children: [
      EPIcon,
      " ",
      __$c("Twitch Controls", "embedpress")
    ] }), initialOpen: false, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextControl$1,
        {
          label: __$c("Start Time (in seconds)", "embedpress"),
          value: startTime,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$3,
        {
          label: __$c("Auto Play", "embedpress"),
          checked: autoplay,
          onChange: (autoplay2) => setAttributes({ autoplay: autoplay2 })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$3,
        {
          label: __$c("Mute On Start", "embedpress"),
          checked: twitchMute,
          onChange: (twitchMute2) => setAttributes({ twitchMute: twitchMute2 })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SelectControl$1,
        {
          label: __$c("Theme", "embedpress"),
          value: twitchTheme,
          options: [
            { label: __$c("Dark", "embedpress"), value: "dark" },
            { label: __$c("Light", "embedpress"), value: "light" }
          ],
          onChange: (twitchTheme2) => setAttributes({ twitchTheme: twitchTheme2 }),
          className: "ep-select-control-field",
          __nextHasNoMarginBottom: true
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ToggleControl$3,
        {
          label: __$c("Fullscreen Button", "embedpress"),
          checked: twitchFullscreen,
          onChange: (twitchFullscreen2) => setAttributes({ twitchFullscreen: twitchFullscreen2 })
        }
      ),
...
function buildTwitchEmbedUrl(baseSrc, attributes2) {
  const {
    autoplay,
    twitchMute,
    twitchTheme,
...
function TwitchEdit({ attributes: attributes2, setAttributes, isSelected }) {
  ...
  const embedUrl = iframeSrc ? buildTwitchEmbedUrl(iframeSrc, attributes2) : "";
  if (!iframeSrc || editingURL) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ...blockProps, children: [
...
const twitchDefaults = typeof embedpressGutenbergData !== "undefined" && embedpressGutenbergData.twitchSettings ? embedpressGutenbergData.twitchSettings : {};
const attributes$2 = {
  url: {
    type: "string",
    default: ""
