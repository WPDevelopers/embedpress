...
class EmbedPressPDFEdit extends Component {
	...
	render() {
		...
		const { href, mime, id, unitoption, width, height, powered_by, themeMode, presentation, position, download, open, toolbar, copy_text, toolbar_position, doc_details, doc_rotation, clientId } = attributes;
