...
export const dynamicStyles = ({ attributes }) => {
    ...
    // const _previewThumbnail = previewThumbnail ? 'block' : 'none';
                    ...
                    <style style={{ display: "none" }}>
                        {
                            `
                            :root {
                                --plyr-color-main: rgba(${parseInt(playerColor.slice(1, 3), 16)}, ${parseInt(playerColor.slice(3, 5), 16)}, ${parseInt(playerColor.slice(5, 7), 16)}, .8); /* Transparent with dynamic color */
                              }
                              
                                [data-source-id="source-${clientId}"] [data-plyr="restart"] {
                                    display: ${_playerRestart};
                                }
                                [data-source-id="source-${clientId}"] [data-plyr="rewind"] {
                                    display: ${_playerRewind};
                                }
                                [data-source-id="source-${clientId}"] [data-plyr="fast-forward"] {
                                    display: ${_playerFastForward};
                                }
