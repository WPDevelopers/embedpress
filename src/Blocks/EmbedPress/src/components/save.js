 ...
 */
import { useBlockProps, RawHTML } from "@wordpress/block-editor";
...
/**
 * Generate social share HTML to match editor layout
 *
 * @param {string} position - Share position
 * @param {object} attributes - Block attributes
 * @returns {string} - Share HTML
 */
function generateShareHTML(position, attributes) {
    const {
        shareFacebook = true,
        shareTwitter = true,
        sharePinterest = true,
    ...
    let html = `<div class="ep-social-share share-position-${position || 'right'}">`;
