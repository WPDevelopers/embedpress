...
export const getPlayerOptions = ({ attributes }) => {
    ...
    const playerOptions = {
        ...
        showCurrentTime:   showCurrentTime   ?? true,
        showDuration:      showDuration      ?? true,
        showMute:          showMute          ?? true,
        showVolume:        showVolume        ?? true,
        showCaptions:      showCaptions      ?? true,
        showSettings:      showSettings      ?? true,
        showFullscreen:    showFullscreen    ?? true,
        showPip:           showPictureInPicture ?? true,
        showLoop:          showLoop          ?? false,
        showPlaybackSpeed: showPlaybackSpeed ?? true,
        showRestart:       showRestart       ?? true,
        showSeek:          showSeek          ?? true,
        // YouTube
