...
const Inspector = ({ attributes, setAttributes }) => {
    ...
    return (
        <InspectorControls>
            <PanelBody title={<div className="ep-pannel-icon">{EPIcon} {__('Embed Size', 'embedpress')}</div>} className="embedpress-google-forms-control">

                <div className={'ep-google-forms-width-control'}>
                    <RadioControl
                        selected={unitoption}
                        options={[
                            { label: '%', value: '%' },
            ...
            <PanelBody title={<div className="ep-pannel-icon">{EPIcon} {__('General', 'embedpress')}</div>} className="embedpress-google-forms-general">
                <ToggleControl
