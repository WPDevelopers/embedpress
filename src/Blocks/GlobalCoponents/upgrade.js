        ...
        <div className={`plugin-rating${!turn_off_rating_help ? ' turn_off_ratting_help' : ''}`}>
            ...
            {/* just disabled rating and feedback */}
            {
                turn_off_rating_help && false && (
                    <div className="ep-upgrade-frame">
...

            {
                !isProPluginActive && (
                    <div className="upgrade-box">
                        ...
                        <a href="https://embedpress.com/in/unlock-gutenberg-controls" target="_blank" className="upgrade-link">Upgrade to PRO</a>
                    </div>
                )
            }
